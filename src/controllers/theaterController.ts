...
export const f_getAllTheaters = async (p_req: Request, p_res: Response): Promise<void> => {
  try {
...
export const f_getTheaterById = async (p_req: Request, p_res: Response): Promise<void> => {
  try {
    const v_theater = await Theater.findById(p_req.params.id);
    if (!v_theater) {
      p_res.status(404).json({ message: 'Theater not found' });
      return;
    }
...
export const f_createTheater = async (p_req: Request, p_res: Response): Promise<void> => {
  try {
...
export const f_updateTheater = async (p_req: Request, p_res: Response): Promise<void> => {
  try {
...
export const f_deleteTheater = async (p_req: Request, p_res: Response): Promise<void> => {
  try {
